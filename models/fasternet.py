...
if __name__ == '__main__':
    import yaml
    #model = fasternet_t0(weights='fasternet_t0-epoch.281-val_acc1.71.9180.pt', cfg='cfg/fasternet_t0.yaml')
    model = fasternet_t0(weights=None, cfg='cfg/fasternet_t0.yaml')
    print(model.channel)
